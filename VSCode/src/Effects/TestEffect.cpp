...
TestEffect::TestEffect(ControlManager *ControlManager, uint32 SampleRate)
	: Effect(ControlManager),
	  m_Test(SampleRate)
{
	m_Pot1 = ControlManager->CreatePotentiometer(GPIOPins::Pin13);
	...
	m_Pot2 = ControlManager->CreatePotentiometer(GPIOPins::Pin14);
	...
	m_Pot3 = ControlManager->CreatePotentiometer(GPIOPins::Pin15);
